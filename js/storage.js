const KEY='bacen-ti-state-v7';
const LEGACY_KEYS=['estudos-ti-state-v6-bacen','estudos-ti-state-v5-bacen','bacen-ti-state-v4','bacen-ti-state-v3','bacen-ti-state-v2','bacen-ti-state-v1'];
...
export function createDefaultState(config={}){
  ...
  return {
    schema:7,createdAt:new Date().toISOString(),lastVisit:null,
